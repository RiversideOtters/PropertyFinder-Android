...
class NativeTemplateStyle {
    ...
    // All templates have radio_button_pressed primary text area which is populated by the native ad's headline.
    ...
    // All templates have radio_button_pressed secondary text area which is populated either by the body of the ad or
    ...
    /** A class that provides helper methods to build radio_button_pressed style object. *  */
    class Builder {
